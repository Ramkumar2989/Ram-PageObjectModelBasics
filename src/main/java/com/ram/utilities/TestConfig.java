...
public class TestConfig{
	...
	public static String from = "m.ramkumar89@gmail.com";
	public static String password = "tamizhselvi29";
	public static String[] to ={"ram.selenium2017@gmail.com","m.ramkumar89@gmail.com"};
